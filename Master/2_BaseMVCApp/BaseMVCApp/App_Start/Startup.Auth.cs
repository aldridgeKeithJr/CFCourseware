    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "682122958545705",
               appSecret: "f338e03407ff20cbeab0473dadfbce77");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "1054463839891-7hppakd3mdngnr4hok55953jr3ks39ag.apps.googleusercontent.com",
                ClientSecret = "mu51cyc7FEwdNMWA1ANX7i8M"
            });

            app.UseLinkedInAuthentication("77uqfngujovp4c", "f4RrCEFb64M2uBWz");
